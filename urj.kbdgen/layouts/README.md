# Comments from urj-fyvaproizhe.yaml
...
deadkey = deadkeycontent = result
е05 5 = misc       = ҵ ҥ ҡ љ њ ԇ ӳ ѷ ә ө р̌ ԑ ԩ
ok d04 р = tail       = ҏ ґ ҋ ӆ ҍ ӊ ӎ (≠ ѣ)
ok d06 ы = breve      = ӑ ӗ й ў ю̆ я̆ ө̆ ӂ  
ok d10 п = diaeresis  = ӓ ё ӥ ӧ ӱ ӹ ӭ ӛ ԑ̈ ӫ ӝ ӵ 
ok c01 а = macron     = а̄ е̄ ӣ о̄ ӯ ы̄ ю̄ э̄ я̄
ok c04 ф = descender  = ӷ җ ҙ қ ԯ ң ԥ ҫ ҭ ҳ ҷ ҿ
ok c05 г = hook       = ҩ ҕ ӌ ӄ ԓ ӈ ӽ Ҧ ӻ
c08 к = vertstroke = ҹ ҝ # azerbaijani (obsolete)
c09 л = stroke     = ғ ҟ # abkhaz
ok       = acute      = а́ е́ и́ о́ у́ ы́ ю́ э́ я́ ө́ ү́ ѓ ќ  
```